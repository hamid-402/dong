...
**وضعیت:** 🟢 **در حال اجرا** — قوانین حاکمیتی اسناد مرجع‌اند؛ موج ۰ انجام شد، موج ۱ در جریان.  
...
- `costCenterId` اختیاری در قرارداد پیش‌نویس هزینه سیم‌کشی شد؛ انتخاب آن در فرم هزینه به ادامهٔ موج F موکول است.
...
*آخرین به‌روزرسانی: موج‌های ۰–۶ کامل؛ بخش‌های conversion/charging صریحاً infra-only هستند.*
