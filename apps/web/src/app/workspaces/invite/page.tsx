  ...
  return (
    ...
    >
      <PageHeader
        ...
        description="نقش و فضای کاری را انتخاب کنید؛ توکن دعوت را با همکارانتان به‌اشتراک بگذارید."
        actions={
          <>
            <Link href="/invite">صفحه پذیرش</Link>
            <Link href="/onboarding">فضاهای کاری</Link>
          </>
        }
      />
      ...
      <ProductGrid>
        <SectionCard title="ساخت دعوت" delayClass="delay1">
          {workspaces.length === 0 ? (
            <EmptyHint>
              ابتدا یک فضا بسازید — <Link href="/onboarding">شروع فضای کاری</Link>
            </EmptyHint>
          ) : null}
          <FormStack>
            <SelectField
